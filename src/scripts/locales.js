const locales = {
    ...
    'ru': {
        ...
        'questions-info': 'Если у вас возникли вопросы, обратитесь к разделу ЧаВо, чтобы найти ответы на часто задаваемые вопросы.',
    ...
    'ua': {
        ...
        'questions-info': 'Якщо у вас виникли питання, зверніться до розділу ( Інформація ), щоб знайти відповіді на часто задавані питання.',
