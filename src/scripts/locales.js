const locales = {
    'en': {
        ...
        'partner-description': 'I strive to create intuitive software and make interacting with a computer as simple and comfortable as possible.',
    ...
    'ru': {
        ...
        'partner-name': 'InsiderKeeps',
        'partner-description': 'Я стремлюсь создавать интуитивно понятное программное обеспечение и делать взаимодействие с вашим компьютером максимально простым и комфортным.',
    ...
    'ua': {
        ...
        'partner-name': 'InsiderKeeps',
        'partner-description': 'Я прагну створити інтуїтивно зрозуміле програмне забезпечення і зробити взаємодію з ПК максимально простим і комфортним.',
    ...
    'es': {
        ...
        'partner-name': 'InsiderKeeps',
        'partner-description': 'Me esfuerzo por crear software intuitivo y hacer que la interacción con una computadora sea lo más simple y cómoda posible.',
